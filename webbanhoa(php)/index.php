	      ...
	      <div class="section group">
	      	...
	      	if($product_featheread){
	      	 ...
	      	 ?>
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="details.php?proid=<?php echo $result['productId'] ?>"><img src="admin/uploads/<?php echo $result['image'] ?>" alt="" width="300" height="366"/></a>
			...
			<?php 
	      	...
	      	if($product_new){
	      	 ...
	      	 ?>
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="details.php"><img src="admin/uploads/<?php echo $result_new['image'] ?>" alt="" width="300" height="366" /></a>
