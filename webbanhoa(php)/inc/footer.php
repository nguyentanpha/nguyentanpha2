   ...
   <div class="footer">
	     ...
	     <div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Liên hệ</h4>
						<ul>
							<li><span>0964125155</span></li>
							<li><span>0968323331</span></li>
						</ul>
						<div class="social-icons">
							<h4>Thêm dõi chúng tôi</h4>
					   		  <ul>
							      <li class="facebook"><a href="https://www.facebook.com/phabity.nguyen" target="_blank"> </a></li>
							      <li class="twitter"><a href="https://mobile.twitter.com/Tanpha2" target="_blank"> </a></li>
							      <li class="googleplus"><a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"> </a></li>
